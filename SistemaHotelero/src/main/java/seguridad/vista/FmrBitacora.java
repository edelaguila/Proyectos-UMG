 ...
 */
    ...
    private void initComponents() {
        ...
        JtProductos1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "I_Bitacora", "Id_Usuario", "Fecha", "Hora", "host", "ip", "accion", "tabla"
            }
        ) {
 ...
 try {
            if ((new File("src\\main\\java\\segudidad\\reportes\\help.chm")).exists()) {
                Process p = Runtime
                        .getRuntime()
                        .exec("rundll32 url.dll,FileProtocolHandler src\\main\\java\\segudidad\\reportes\\help.chm ");
                p.waitFor();
            } else {
...
llenadoDeTablas();
        ...
        */
        ...
        Consultar = BicDAO.query(Consultar);
